...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/style.css', Config::get('app.secure'))}}" />
    ...
    <title>Enhancement/Partnership/DSA Fund Online Form</title>
</head>
<body>
@include("layouts.fundonlineheader")
<br>
