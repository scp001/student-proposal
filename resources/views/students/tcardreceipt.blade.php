        ...
        <div class="row"><div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class='row'>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <input type="text" id="tcard" value="{{isset($tcard)? $tcard:''}}" maxlength="20" class="form-control">
                    </div>
                ...
                <div class='row'>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4 text-right">
                        <input type="text" class="form-control" id="utorid" data-validation="required" value="{{isset($utorid)? $utorid:''}}" autofocus maxlength="50">
                ...
                <div class='row'>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                        Meal Plan Price: <input type="text" id="amount"  maxlength="10" value="295.00" disabled class="two-digits form-control" >
                    </div>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                        Total: <input type="text" id="total"  maxlength="10" value="295.00" disabled class="form-control">
                    </div>
                </div>
                ...
                <div class='row'>
                    ...
                    <div id="other_pfd" class="col-md-4 col-sm-4 col-xs-4" style="display:none">
                        <input id="other_pf" name="other_pf" type="text" />
                    </div>
                </div>
