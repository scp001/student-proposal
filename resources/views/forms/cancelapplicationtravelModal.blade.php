<div class="modal fade" id="cancel-travel-application-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Cancel this application, funding no longer required.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">No, stay on this page!</button>
                <button type="button" class="btn btn-success" id="travel-warning-modal-cancel-application">Yes, continue</button>
